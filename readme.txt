...
== Screenshots ==
1. Add a new wallet.
2. Set API Key and Password.
3. Update Wallet.
4. Remove Wallet.
5. Coinremitter Gateway Settings.
6. Admin - Order Detail.
7. Checkout At User Side.
8. User - Order Detail with QR code.
9. User - Order Summary
...
=Can I accept cryptocurrency without registering myself on Coinremitter ?=
	No, you can not. if you want to register yourself then click on this link [Coinremitter](https://blog.coinremitter.com/a-brief-knowledge-about-coinremitter/)
