...
$coinremiter_url = COINREMITTER_API_URL.COINREMITTER_API_VERSION.'/';
    ...
    $payment_history = json_encode($check_transaction['payment_history']);
    $conversion_rate =json_encode($check_transaction['conversion_rate']);
    $paid_amount = json_encode($check_transaction['paid_amount']);
    $total_amount = json_encode($check_transaction['total_amount']);
